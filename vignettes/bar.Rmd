---
title: "Marking bar in shiny.gosling"
...
# Marking bar in a simple shiny.gosling plot
      ...
      arrange_views(
        ...
        views = compose_view(
          tracks = add_single_track(
            ...
            size = visual_channel_size(value = 5)
          )
        )
      )
    )
...
tags$div(
  ...
  tags$iframe(src = "https://connect.appsilon.com/shiny-gosling-bar/", width = 950, height = 350)
)
```
