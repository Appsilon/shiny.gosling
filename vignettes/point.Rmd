---
title: "Marking point in shiny.gosling"
      ...
      arrange_views(
        ...
        views = compose_view(
          tracks = add_single_track(
            ...
            size = visual_channel_size(field = "peak", type = "quantitative")
          )
        )
      )
    )
...
tags$div(
  ...
  tags$iframe(src = "https://connect.appsilon.com/shiny-gosling-point/", width = 950, height = 350)
)
```
