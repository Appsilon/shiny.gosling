...
This package is an R shiny implementation of the [**Gosling.js**](http://gosling-lang.org/) library. Gosling js is a highly *expressive* library based on a *Grammer for scalable and interactive Gnenomics Data visualization*. This library is build upon the [**React** wrapper of the Gosling.js](https://github.com/gosling-lang/gosling-react). Which is powered by [**Shiny.React**](https://github.com/gosling-lang/gosling-react). Thus most of the Charts can be directly build using this package.
...
```{r}
gemini_filepath <- sprintf(
  fmt = "%s/examples/multiTrackApp/data/gemini_multitrack_2_data.csv",
  system.file(package = "shiny.gosling")
)

gemini_github_path <- "https://raw.githubusercontent.com/sehilyi/gemini-datasets/master/data/UCSC.HG38.Human.CytoBandIdeogram.csv"
