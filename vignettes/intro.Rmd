...
This package is an R shiny implementation of the [**Gosling.js**](http://gosling-lang.org/) library. Gosling js is a highly *expressive* library based on a *Grammar for scalable and interactive Genomics Data visualization*. This library is build upon the [**React** wrapper of the Gosling.js](https://github.com/gosling-lang/gosling-react-example). Which is powered by [**Shiny.React**](https://github.com/gosling-lang/gosling-react-example). Thus most of the Charts can be directly build using this package.
