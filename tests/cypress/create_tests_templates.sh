...
rscript_command="Rscript cypress/r_scripts/$r_script_out"
e2e_command="start-server-and-test $escaped_custom_text http://localhost:8888 'cypress run --spec \"cypress/e2e/$cy_spec_out\" --record false'"
