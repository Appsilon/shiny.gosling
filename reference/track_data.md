...
- type:
  ...
  A character. Type of data. One of "csv", "json", "bigwig", "bam",
...
- genomicFieldsToConvert:
  ...
  Define the genomic fields from the data in list format. Experimental
  Property. Each object follows the format
...
For info visit http://gosling-lang.org/docs/data. Check the various
supported data formats and their parameters. All of them can be
